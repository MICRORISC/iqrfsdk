...
public final class SPI_Status {
    public static final int NOT_ACTIVE_DISABLED     = 0x00;
    ...
    /** Bottom limit of SPI data ready mode */
    public static final int DATA_READY_BOTTOM_LIMIT = 0x40;
    
    /** Maximal data length for OS v3.00 or lower. */
    public static final int OS300_MAX_DATA_LEN = 41;
    
    /** Maximal data length for OS v3.01D or higher. */
    public static final int OS301D_MAX_DATA_LEN = 64;
     ...
     */
    public SPI_Status(int value, boolean dataReady) {
        this.value = value;
