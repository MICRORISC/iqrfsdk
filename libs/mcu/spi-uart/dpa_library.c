...
UINT16 DPA_GetEstimatedTimeout(void)
{
	...
	estimatedTimeout = dpaLibDpaAnswer.Extension.Confirmation.Hops * dpaLibDpaAnswer.Extension.Confirmation.TimeSlotLength * 10;
	estimatedTimeout += (dpaLibDpaAnswer.Extension.Confirmation.HopsResponse * 50 + 40);
