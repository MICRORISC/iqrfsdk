...
${OBJECTDIR}/modules/errors.o: modules/errors.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/errors.o modules/errors.c

${OBJECTDIR}/platforms/linux/rpi_io.o: platforms/linux/rpi_io.c 
	${MKDIR} -p ${OBJECTDIR}/platforms/linux
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/platforms/linux/rpi_io.o platforms/linux/rpi_io.c
