...
${OBJECTDIR}/modules/CDCImplException.o: modules/CDCImplException.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/CDCImplException.o modules/CDCImplException.cpp

${OBJECTDIR}/modules/CDCMessageParserException.o: modules/CDCMessageParserException.cpp 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/CDCMessageParserException.o modules/CDCMessageParserException.cpp

${OBJECTDIR}/modules/CDCReceiveException.o: modules/CDCReceiveException.cpp 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/CDCReceiveException.o modules/CDCReceiveException.cpp

${OBJECTDIR}/modules/CDCSendException.o: modules/CDCSendException.cpp 
	${MKDIR} -p ${OBJECTDIR}/modules
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/modules/CDCSendException.o modules/CDCSendException.cpp

${OBJECTDIR}/platforms/linux/CDCImpl.o: platforms/linux/CDCImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}/platforms/linux
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/platforms/linux/CDCImpl.o platforms/linux/CDCImpl.cpp

${OBJECTDIR}/platforms/linux/CDCMessageParser.o: platforms/linux/CDCMessageParser.cpp 
	${MKDIR} -p ${OBJECTDIR}/platforms/linux
	${RM} "$@.d"
	$(COMPILE.cc) -g -Ih -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/platforms/linux/CDCMessageParser.o platforms/linux/CDCMessageParser.cpp
