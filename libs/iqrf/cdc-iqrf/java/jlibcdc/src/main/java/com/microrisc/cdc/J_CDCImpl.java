...
public class J_CDCImpl {
     ...
     */
    public void resetUSBDevice() throws J_CDCSendException, J_CDCReceiveException, Exception {
     ...
     * @throws Exception if other error occurs
     */
    public void resetTRModule() throws J_CDCSendException, J_CDCReceiveException, Exception {
     ...
     * @throws Exception if other error occurs
     */
    public J_DeviceInfo getUSBDeviceInfo() throws J_CDCSendException, J_CDCReceiveException, Exception {
     ...
     * @throws Exception if other error occurs
     */
    public J_ModuleInfo getTRModuleInfo() throws J_CDCSendException, J_CDCReceiveException, Exception {
     ...
     * @throws Exception if other error occurs
     */
    public void indicateConnectivity() throws J_CDCSendException, J_CDCReceiveException, Exception {
     ...
     * @throws Exception if other error occurs
     */
    public J_SPIStatus getSPIStatus() throws J_CDCSendException, J_CDCReceiveException, Exception {
     ...
     * @throws Exception if other error occurs
     */
    public J_DSResponse sendData(short[] data) throws J_CDCSendException, J_CDCReceiveException, Exception {
     ...
     * @throws Exception if other error occurs
     */
    public void switchToCustom() throws J_CDCSendException, J_CDCReceiveException, Exception {
