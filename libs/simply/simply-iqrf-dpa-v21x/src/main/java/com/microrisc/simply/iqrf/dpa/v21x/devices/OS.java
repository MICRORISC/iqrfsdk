...
import com.microrisc.simply.iqrf.dpa.v21x.types.SleepInfo;
...
public interface OS
     ...
     * itself within series of individual DPA requests. Using Run discover is not 
     * allowed inside batch command list too.
