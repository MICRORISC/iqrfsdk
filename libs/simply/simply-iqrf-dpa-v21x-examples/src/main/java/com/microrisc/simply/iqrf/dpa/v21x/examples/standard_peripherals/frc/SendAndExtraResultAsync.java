...
package com.microrisc.simply.iqrf.dpa.v21x.examples.standard_peripherals.frc;
...
public class SendAndExtraResultAsync {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // eg. for 5 bonded nodes and FRC response time 40ms
        // + overhead for Java framework = 2s
        
        short overhead = 2;
        boolean std = true; // indicates if is used STD or LP mode
        long timeout = overhead + 5 * (std ? 150 : 200) + (long) 40 + (std ? 290 : 390);
