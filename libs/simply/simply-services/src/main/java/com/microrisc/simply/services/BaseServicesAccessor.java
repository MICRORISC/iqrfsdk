...
/**
 * Base initial implementation of Services Accessor.
 * 
 * @author Michal Konopa
 */
public class BaseServicesAccessor implements ServicesAccessor {
    /** Map of services. */
    protected final Map<Class, Service> servicesMap;
    
    
    public BaseServicesAccessor(Map<Class, Service> servicesMap) {
