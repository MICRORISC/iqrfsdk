...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x1DE6,                 // Vendor ID: MICRORISC s.r.o.
    0x0001,                 // Product ID: IQRF USB Device
...
ROM USB_DEVICE_DESCRIPTOR cdc_device_dsc=
{
    0x12,                   // Size of this descriptor in bytes
    USB_DESCRIPTOR_DEVICE,  // DEVICE descriptor type
    ...
    USB_EP0_BUFF_SIZE,      // Max packet size for EP0, see usb_config.h
    0x1De6,                 // Vendor ID: MICRORISC s.r.o.
    0x0002,                 // Product ID: CDC RS-232 Emulation Demo
...
// my
/* Configuration CDC Descriptor */
ROM BYTE configDescriptor_CDC[]={
    /* Configuration Descriptor */
    0x09,//sizeof(USB_CFG_DSC),    // Size of this descriptor in bytes
    USB_DESCRIPTOR_CONFIGURATION,                // CONFIGURATION descriptor type
...
{'M','I','C','R','O','R','I','S','C',' ','s','.','r','.','o','.'}};

//Product string descriptor
ROM struct{BYTE bLength;BYTE bDscType;WORD string[15];}sd002={
sizeof(sd002),USB_DESCRIPTOR_STRING,
{'I','Q','R','F',' ','U','S','B',' ','D','e','v','i','c','e'}}; 

//Product string descriptor - CDC
ROM struct{BYTE bLength;BYTE bDscType;WORD string[26];}sd003={
...
ROM BYTE *ROM USB_CD_Ptr[]=
{
    ...
    (ROM BYTE *ROM)&configDescriptor_CDC
};
