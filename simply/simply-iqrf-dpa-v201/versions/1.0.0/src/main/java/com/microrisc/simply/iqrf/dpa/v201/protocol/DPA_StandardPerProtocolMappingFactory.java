...
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.AddressingInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.ArrayIO_CommandConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.ArrayIO_DirectionSettingsConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.ArrayPeripheralInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.BatchCommandConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.BaudRateConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.BondedDeviceConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.BondedNodesConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.DPA_AdditionalInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.DPA_ParameterConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.DiscoveredNodesConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.DiscoveryParamsConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.DiscoveryResultConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.FRC_CommandConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.FRC_DataConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.HWP_ConfigurationConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.LED_StateConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.NodeStatusInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.OsInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.PWM_ParametersConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.PeripheralEnumerationConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.PeripheralInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.RemotelyBondedModuleIdConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.RoutingHopsConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.SleepInfoConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.SubDPARequestConvertor;
import com.microrisc.simply.iqrf.dpa.v201.typeconvertors.ThermometerValueConvertor;
...
public final class DPA_StandardPerProtocolMappingFactory implements ProtocolMappingFactory {
    ...
    static private List<ValueToPacketMapping> createRequestNodeMappings() {
        List<ValueToPacketMapping> mappings = new LinkedList<>();
        ValueToPacketMapping nodeMapping = new ValueToPacketMapping(
                0, StringToByteConvertor.getInstance()
        );
    ...
    static private PacketToInterfaceMapping createResponseThermometerMapping() {
        List<PacketPositionValues> packetValues = new LinkedList<>();
        packetValues.add( new PacketPositionValues(2, (short)0x0A));
