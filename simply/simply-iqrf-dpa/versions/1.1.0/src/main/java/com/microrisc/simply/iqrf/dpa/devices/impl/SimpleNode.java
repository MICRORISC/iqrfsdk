...
extends DPA_DeviceObject implements Node {
    ...
    public VoidType clearRemotelyBondedModuleId() {
        UUID uid = dispatchCall("5", new Object[] { getHwProfile() }, getDefaultWaitingTimeout() );
        if ( uid == null ) {
            return null;
        }
        return getCallResult(uid, VoidType.class, getDefaultWaitingTimeout() );
    ...
    public VoidType removeBondAddress() {
        UUID uid = dispatchCall("6", new Object[] { getHwProfile() }, getDefaultWaitingTimeout() );
        if ( uid == null ) {
            return null;
        }
        return getCallResult(uid, VoidType.class, getDefaultWaitingTimeout());
    ...
    public VoidType restore(short[] networkData) {
        ...
        UUID uid = dispatchCall(
                "8", new Object[] { getHwProfile(), networkData }, getDefaultWaitingTimeout()
        );
        if ( uid == null ) {
            return null;
        }
