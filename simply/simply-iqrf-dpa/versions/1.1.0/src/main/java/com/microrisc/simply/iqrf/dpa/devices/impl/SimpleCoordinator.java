...
extends DPA_DeviceObject implements Coordinator {
    ...
    public DiscoveryResult runDiscovery(DiscoveryParams discoveryParams) {
        UUID uid = dispatchCall(
                "8", new Object[] { getHwProfile(), discoveryParams }, getDefaultWaitingTimeout() 
        );
        if ( uid == null ) {
            return null;
        }
    ...
    public DPA_Parameter setDPA_Param(DPA_Parameter dpaParams) {
        UUID uid = dispatchCall(
                "9", new Object[] { getHwProfile(), dpaParams }, getDefaultWaitingTimeout() 
        );
        if ( uid == null ) {
            return null;
        }
    ...
    public RoutingHops setHops(RoutingHops hops) {
        UUID uid = dispatchCall(
                "10", new Object[] { getHwProfile(), hops }, getDefaultWaitingTimeout() 
        );
        if ( uid == null ) {
            return null;
        }
    ...
    public VoidType restore(short[] networkData) {
        ...
        UUID uid = dispatchCall(
                "13", new Object[] { getHwProfile(), networkData }, getDefaultWaitingTimeout()
        );
        if ( uid == null ) {
            return null;
        }
    ...
    public RemotelyBondedModuleId readRemotelyBondedModuleId() {
        UUID uid = dispatchCall("17", new Object[] { getHwProfile() }, getDefaultWaitingTimeout() );
        if ( uid == null ) {
            return null;
        }
    ...
    public VoidType clearRemotelyBondedModuleId() {
        UUID uid = dispatchCall("18", new Object[] { getHwProfile() }, getDefaultWaitingTimeout() );
        if ( uid == null ) {
            return null;
        }
        return getCallResult(uid, VoidType.class, getDefaultWaitingTimeout() );
