...
public final class PeripheralInfoConvertor extends PrimitiveConvertor {
    ...
    public Object toObject(short[] protoValue) throws ValueConversionException {
        ...
        if ( perType == null ) {
            throw new ValueConversionException("Unknown value of peripheral type: " + 
                    protoValue[PER_TYPE_POS]);
        }
        ...
        if ( extPerChar == null ) {
            throw new ValueConversionException("Unknown value of extended peripheral type: " 
                    + protoValue[EXT_PER_TYPE_POS]);
        }
        
        PeripheralInfo perInfo = new PeripheralInfo(perType, extPerChar, 
                protoValue[PARAM1_POS], protoValue[PARAM2_POS]);
