...
public final class PeripheralEnumerationConvertor extends PrimitiveConvertor {
    ...
    static private final int HWPROFTYPE_POS = 7;
    static private final int HWPROFTYPE_LENGTH = 2;
    ...
    // returns HW Profile Type
    private int getHwProfType(short[] protoValue) {
        ByteBuffer byteBuffer = ByteBuffer.allocate(4);
        byteBuffer.order(ByteOrder.LITTLE_ENDIAN);
        
        for (int byteId = 0; byteId < HWPROFTYPE_LENGTH; byteId++) {
            byteBuffer.put((byte)protoValue[HWPROFTYPE_POS + byteId]);
        }
    ...
    public Object toObject(short[] protoValue) throws ValueConversionException {
        ...
        int hwProfType = getHwProfType(protoValue);
